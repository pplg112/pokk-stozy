  ...
  if (provider === "adsense" && ADS_CONFIG.adsense.enabled && ADS_CONFIG.adsense.clientId) {
    ...
    return (
      <div className={`w-full overflow-hidden my-4 sm:my-5 ${className}`}>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 text-[11px] font-mono text-slate-400 mb-2 px-1">
        ...
        {/* Compact Esports Sponsor Card */}
        <div className="w-full rounded-2xl border border-green-500/30 bg-gradient-to-r from-[#0d1512] via-[#0e1017] to-[#0c141d] p-4 sm:p-4.5 shadow-lg relative overflow-hidden">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3.5 relative z-10">
            <div className="flex items-center gap-3">
              <div className="p-2.5 rounded-xl bg-green-500/10 border border-green-500/30 text-green-400 shrink-0">
              ...
              <div className="space-y-0.5">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 text-[10px] rounded-md bg-green-500/20 text-green-400 font-mono font-bold border border-green-500/30">
                    {partner.badgeText}
                  </span>
                </div>
            ...
            <a
              ...
              className="shrink-0 self-start md:self-center px-4 py-2 rounded-xl text-xs sm:text-sm font-mono font-bold text-slate-950 bg-green-400 hover:bg-green-300 transition-all flex items-center justify-center gap-1.5 shadow-md shadow-green-500/20 hover:shadow-green-500/35"
            >
