...
export const INITIAL_REAL_PRODUCTS: RealProduct[] = [
  {
    ...
    "imageUrl": "/images/products/pokky-1788529027101.png",
  ...
  },
  {
    ...
    "active": true,
    "features": [
      "ปรับแต่ง Keyboard & Mouse Data Queue Size (kbdclass/mouclass) ลด Input Lag สำหรับเมาส์ 1000Hz - 4000Hz",
      "สูตร Win32PrioritySeparation + AVX2 Priority Boost ปรับแต่งเจาะจงสำหรับ CPU สเปกสูง (เช่น Ryzen 7800X3D / Intel Core)",
      "สคริปต์ PowerShell Network Tweaker ปรับแต่งการตั้งค่าฮาร์ดแวร์การ์ดแลน (NIC) เชิงลึก",
      "ปิด Energy Efficient Ethernet (EEE) และ Green Ethernet เพื่อป้องกันการ์ดแลนตัดไฟหรือดรอปสปีด",
      "ปรับขนาด Receive Buffers และ Transmit Buffers ป้องกัน Packet Drop ระหว่างเล่นเกมออนไลน์",
      "มาพร้อมโปรแกรม SpeedGuide TCP Optimizer ในตัวสำหรับตั้งค่า Network Stack ขั้นสูง",
      "คู่มือภาพ Step-by-Step ละเอียด 32 ขั้นตอนสำหรับการตั้งค่า Network Control Panel และ Adapter Properties",
      "มีสคริปต์ Revert คืนค่า Data Queue และ PriorityControl สู่ค่าเริ่มต้นของ Windows อย่างปลอดภัย"
    ],
    "requirements": [
      "Windows 10 หรือ Windows 11 (64-bit ทุกเวอร์ชัน)",
      "สิทธิ์ Administrator (สำหรับการรัน PowerShell Script และนำเข้า Registry)",
      "รีสตาร์ตเครื่องคอมพิวเตอร์หลังทำการเซ็ตค่าเพื่อเปิดใช้งาน Data Queue ใหม่"
    ],
    "includedFiles": [
      {
    ...
    "imageUrl": "/images/products/pokky-1788585249542.png",
  ...
  },
  {
    ...
    "active": true,
    "features": [
      "ปรับแต่ง BCD ปิด Dynamic Tick & Platform Clock (HPET Off) เพิ่มความนิ่งของ Frame Time",
      "สูตร CPU Win32PrioritySeparation = 38 ปรับจูน Short Fixed Quantum สำหรับ AMD 3D V-Cache & Intel",
      "เปิด Hardware-Accelerated GPU Scheduling (HAGS: HwSchMode = 2) ดึงพลังการ์ดจอเต็มร้อย",
      "ปรับแต่ง MMCSS และ Games Profile จัด GPU Priority = 8 และ SFIO Priority = High ให้เกมระดับสูงสุด",
      "ปลดล็อก TCP/IP Stack: TcpAckFrequency = 1, TCPNoDelay = 1 และ Congestion Provider = CTCP ลด Ping ขั้นสุด",
      "ปิด Interrupt Moderation, Flow Control และ Large Send Offload (LSO) ในระดับ Network Adapter",
      "ตั้งค่า Cloudflare (1.1.1.1) & Google DNS อัตโนมัติ เพิ่มความเร็วและความเสถียรในการเชื่อมต่อเซิร์ฟเวอร์เกม",
      "ปรับแต่ง Mouse & Keyboard Response ไร้ดีเลย์ (Delay = 0, Speed = 31) พร้อมล้างไฟล์ขยะและ Bloatware ในระบบ"
    ],
    "requirements": [
      "Windows 10 หรือ Windows 11 (64-bit ทุกรุ่น)",
      "สิทธิ์ Administrator (คลิกขวาเลือก Run as Administrator)",
      "รีสตาร์ตเครื่อง 1 ครั้งหลังรันสคริปต์เพื่อให้ค่า BCD และ Registry มีผลสมบูรณ์"
    ],
    "includedFiles": [
      {
        "filename": "X3D INTEL V2/t.bat",
        "description": "สคริปต์ปรับแต่ง Network Stack, Cloudflare DNS, ปิด Interrupt Moderation และปิด Telemetry"
      },
      {
        "filename": "X3D INTEL V2/X3d intel.bat",
        "description": "สคริปต์ปรับแต่ง CPU Win32PrioritySeparation, MMCSS, HAGS, BCD, ปรับเมาส์/คีย์บอร์ด และ Ultimate Power Plan"
      }
    ],
    ...
    "imageUrl": "/images/products/pokky-1788553424279.png",
  ...
  },
  {
    ...
    "imageUrl": "/images/products/pokky-1788536637641.png",
  ...
  },
  {
    ...
    "active": true,
    "features": [
      "คอนฟิกพิเศษสำหรับ FiveM / GTA V (CitizenFX.txt) แก้อาการแมพโหลดไม่ทันและ Texture หาย",
      "ปรับแต่ง Streaming Memory Pool Size ใน FiveM ให้โหลดวัตถุและโมเดลรถในเซิร์ฟเวอร์ RP ได้ลื่นไหลไม่มีสะดุด",
      "ปรับ Render Thread Priority และ Shadow Cascade Distance เพื่อดัน FPS ในจุดที่คนและรถหนาแน่น",
      "คำสั่งสคริปต์ปรับแต่ง Windows System Responsiveness & Process Priority เฉพาะทางสำหรับสายแข่ง",
      "ปลดล็อก Power Plan ประสิทธิภาพสูงสุด ป้องกัน CPU Downclock ระหว่างเล่นเกม FiveM",
      "แถมฟรีลิงก์คลิปวิดีโอสอนปรับมือ (Manual Tuning Guide) จากผู้เชี่ยวชาญแบบจับมือทำทีละขั้นตอน",
      "คู่มือวิธีใช้งานภาษาไทยแบบเข้าใจง่าย พร้อมเทคนิคเคลียร์แคช FiveM อย่างถูกวิธี",
      "มีสคริปต์ Revert คืนค่าระบบเน็ตเวิร์กและ Power Plan สู่ค่ามาตรฐานได้ในคลิกเดียว"
    ],
    "requirements": [
      "Windows 10 หรือ Windows 11 (64-bit ทุกรุ่น)",
      "สำหรับผู้เล่น FiveM, GTA V หรือเกมออนไลน์สาย Esports ที่ต้องการความลื่นไหลสูงสุด",
      "สิทธิ์ Administrator (คลิกขวาเลือก Run as Administrator)"
    ],
    "includedFiles": [
      {
        "filename": "PROJECT S  V7/ใส่ในCitizenFX.txt",
        "description": "ไฟล์ตั้งค่าการประมวลผล Texture และ Graphic Pool สำหรับ FiveM / GTA V"
      },
      {
        "filename": "PROJECT S  V7/PROJECT S .txt",
        "description": "ชุดคำสั่งปรับแต่งความเร็วและ Latency ระบบ Windows"
      },
      {
        "filename": "PROJECT S  V7/คลิปปรับมือ.txt",
        "description": "ลิงก์วิดีโอสอนการตั้งค่าและเทคนิคการปรับแต่งด้วยตนเอง"
      },
      {
        "filename": "PROJECT S  V7/วิธีใช้.txt",
        "description": "คำอธิบายขั้นตอนการติดตั้งและการเปิดใช้งานสคริปต์"
      },
      {
        "filename": "REVERT_PROJECT S  V7.bat",
        "description": "สคริปต์กู้คืนการตั้งค่าเน็ตเวิร์กและ Power Plan สู่ค่ามาตรฐาน"
      }
    ],
    ...
    "imageUrl": "/images/products/pokky-1788586545769.png",
  ...
  },
  {
    ...
    "active": true,
    "features": [
      "ปลดล็อก Windows Kernel Timer Resolution จาก 15.6ms เหลือ 0.5ms (ความเร็วรอบนาฬิการะดับสูงสุด)",
      "ลด Quantization Delay ของระบบปฏิบัติการ ทำให้การตอบสนองของเมาส์และคีย์บอร์ดแม่นยำในระดับมิลลิวินาที",
      "ดึงศักยภาพเมาส์เกมมิ่ง Polling Rate สูง (1000Hz, 4000Hz, 8000Hz) ให้ส่งสัญญาณได้เต็มประสิทธิภาพ ไร้ Packet Drop",
      "ปรับ BCD ลบ useplatformclock และ useplatformtick เพื่อสลับไปใช้ Invariant TSC แทน HPET ที่กินดีเลย์สูง",
      "ลดอาการ Frametime Jitter และ Micro-stuttering ช่วยให้เฟรมเรตนิ่งขึ้นอย่างเห็นได้ชัด",
      "เหมาะสำหรับเกมแนว FPS ยิงเร็วระดับ Esports เช่น Valorant, Counter-Strike 2, Apex Legends, และ Overwatch 2",
      "โปรแกรม Portable น้ำหนักเบา (7 KB) เปิดใช้งานได้ทันที ไม่ต้องติดตั้ง ไม่กินแรม",
      "มาพร้อมสคริปต์ Revert คืนค่า BCD Timer Resolution กลับสู่ค่าเริ่มต้นของ Windows ได้อย่างปลอดภัย 100%"
    ],
    "requirements": [
      "Windows 10 หรือ Windows 11 (64-bit ทุกเวอร์ชัน)",
      "สิทธิ์ Administrator (สำหรับการตั้งค่า BCD และการปรับความละเอียด Timer)",
      "เปิดโปรแกรมค้างไว้ขณะเล่นเกมเพื่อให้ค่า Timer Resolution คงอยู่ที่ 0.5ms"
    ],
    "includedFiles": [
      {
        "filename": "TimerResolution.exe",
        "description": "โปรแกรม Portable สำหรับสั่งการ Windows Kernel ให้ลด Timer Resolution เหลือ 0.5ms"
      }
    ],
    ...
    "imageUrl": "/images/products/pokky-1788538939543.png",
